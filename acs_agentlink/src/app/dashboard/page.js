...
const percentageChange = feedback_chart.percentage_change;
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="flex flex-col pb-10 space-y-4 justify-center items-center">
         ...
         {data.feedbacks && data.feedbacks.length > 0 && <><p className="text-[#101828] text-[28px]">{data.feedbacks[0].text}</p>
    ...
    >
      <Image
        src={isIncrease?ArrowUpGreen : ArrowDownRed} // Use the same arrow-up icon
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[#101828] pt-10">
        ...
        <div>
          <div className="pb-5 flex justify-between items-center">
            ...
            <Link href="/dashboard/jobs" className="flex">
          ...
          {active_jobs.map((job) => (
            <div key={job.id} className="p-5 border rounded-2xl bg-grayscale-white space-y-5 mb-3">
              <div className="flex justify-between items-center">
                <div className="flex gap-4 items-center">
                  <Image src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/storage` + job.image} className="border border-gray-200 rounded-2xl" alt="Job Icon" width={80} height={80}/>
                  <div>
              ...
              <div>
                ...
                <div className="flex space-x-5">
                  {job.apps.map((app) => (
                      ...
                      <Image src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/` + app.image}  style={{height: "15px"}} alt="Icon" width={20}
height={20} />
                      {app.name}
                    </div>
            ...
            <div className="p- space-y-6">
              {feedbacks &&
                feedbacks.map((feedback, index) => (
                  <div key={feedback.id} className="space-y-2 border rounded-2xl bg-grayscale-white p-5">
                    <div className="flex justify-between items-center">
                      <h1 className="text-lg">{feedback.text}</h1>
